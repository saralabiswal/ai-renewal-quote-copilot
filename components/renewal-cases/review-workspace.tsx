              ...
              <section className="guidance-section">
                ...
                <div className="guidance-section-content">
                  {aiExecutiveSummary?.content ? (
                    <FormattedAiText text={aiExecutiveSummary.content} />
                  ) : (
            ...
            <div className="card guidance-review-card">
              <section className="guidance-section">
                ...
                <div className="guidance-section-content">
                  {aiApprovalBrief?.content ? (
                    <FormattedAiText text={aiApprovalBrief.content} />
                  ) : (
              ...
              {reasoningApproval ? (
                <details className="guidance-evidence-details">
                  ...
                  <div className="guidance-section-content">
                    <FormattedAiText text={reasoningApproval.content} />
                  </div>
                </details>
              ) : null}
            </div>
              ...
              <section className="guidance-section">
                ...
                <div className="guidance-section-content">
                  {narrative?.content ? (
                    ...
                    <span className="muted">No rationale is available.</span>
                  )}
                </div>
              </section>
              ...
              <details className="guidance-evidence-details">
                ...
                <div className="guidance-section-content">
                  {reasoningRecommendation?.content ? (
                    <FormattedAiText text={reasoningRecommendation.content} />
                  ) : (
              ...
              <details className="guidance-evidence-details">
                ...
                <div className="guidance-section-content">
                  {reasoningWhatChanged?.content ? (
                    <FormattedAiText text={reasoningWhatChanged.content} />
                  ) : (
                    <span className="muted">
