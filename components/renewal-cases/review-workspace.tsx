            ...
            <div className="card guidance-metadata-card">
              <div className="guidance-metadata-grid">
                ...
                <div className="guidance-metadata-item">
                  ...
                  <div>{formatDisplayLabel(recalculationMeta.generatedBy)}</div>
                </div>
                <div className="guidance-metadata-item">
              ...
              <div className="guidance-drivers">
                ...
                {recalculationMeta.ml ? (
                  <div className="guidance-driver-list">
                    <span className="guidance-driver-chip">
                      Mode: {formatDisplayLabel(recalculationMeta.ml.mode)}
                    </span>
                    <span className="guidance-driver-chip">
                      Status: {formatDisplayLabel(recalculationMeta.ml.status)}
                    </span>
                    <span className="guidance-driver-chip">
                      {recalculationMeta.ml.affectsRecommendation
                        ? 'ML-Assisted: affects recommendation'
                        : 'Shadow: does not affect recommendation'}
                    </span>
                    {recalculationMeta.ml.bundleRiskScore != null ? (
                      <span className="guidance-driver-chip">
                        ML Bundle Risk: {Math.round(recalculationMeta.ml.bundleRiskScore)}
                      </span>
                    ) : null}
                    {recalculationMeta.ml.error ? (
                      <span className="guidance-driver-chip">
                        {recalculationMeta.ml.error}
                      </span>
                    ) : null}
                  ...
                  <div className="small muted">ML scoring is disabled for this recalculation.</div>
                )}
              </div>
            </div>
          ) : null}
